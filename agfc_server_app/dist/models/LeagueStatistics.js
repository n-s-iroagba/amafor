    ...
    hooks: {
        beforeValidate: (statistic) => {
            ...
            if (statistic.matchesPlayed > 0) {
                statistic.avgGoalsPerMatch = Number((statistic.goalsFor / statistic.matchesPlayed).toFixed(2));
                statistic.avgGoalsConcededPerMatch = Number((statistic.goalsAgainst / statistic.matchesPlayed).toFixed(2));
            }
        },
    },
});
