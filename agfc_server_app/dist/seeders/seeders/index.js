...
const initializeSeeders = () => {
    ...
    runner.register('thirdPartyArticles', new third_party_article_seeder_1.ThirdPartyArticleSeeder(), ['rssFeedSources']);
    ...
    runner.register('matchImages', new matchimage_seeder_1.MatchImageSeeder(), ['fixtures']);
