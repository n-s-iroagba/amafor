...
exports.ThirdPartyArticle = void 0;
const sequelize_1 = require("sequelize");
const database_1 = __importDefault(require("../config/database"));
const RssFeedSource_1 = require("./RssFeedSource");
// 3️⃣ Define the model class
class ThirdPartyArticle extends sequelize_1.Model {
}
exports.ThirdPartyArticle = ThirdPartyArticle;
...
ThirdPartyArticle.belongsTo(RssFeedSource_1.RssFeedSource, {
    foreignKey: 'rss_feed_source_id',
    as: 'feed_source',
});
//# sourceMappingURL=ThirdPartyArticle.js.map