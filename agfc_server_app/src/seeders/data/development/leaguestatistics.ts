// data/development/league-statistics.ts
...
export const developmentLeagueStatistics: LeagueStatisticsAttributes[] = [
  // 1. Academy U17 (The winner)
  {
    id: 'ls1ls1ls-ls1ls-ls1ls-ls1ls-ls1ls1ls1ls1',
    leagueId: LEAGUE_ID,
    team: 'Academy U17',
    fixtureId: FIXTURE_ID as any, // Cast if model expects number vs UUID string mismatch in definitions
    matchesPlayed: 1,
    wins: 1,
    draws: 0,
    losses: 0,
    ...
    cleanSheets: 0,
    failedToScore: 0,
    avgGoalsPerMatch: 2.00,
    avgGoalsConcededPerMatch: 1.00,
  ...
  // 2. City Strikers (The loser)
  {
    ...
    cleanSheets: 0,
    failedToScore: 0,
    avgGoalsPerMatch: 1.00,
    avgGoalsConcededPerMatch: 2.00,
    lastMatchDate: YESTERDAY,
    createdAt: new Date(),
    updatedAt: new Date(),
  }
