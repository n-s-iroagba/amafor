// data/development/advertiser.ts
import { AdvertiserAttributes } from "../../../models/Advertiser";

export const productionAdvertisers: AdvertiserAttributes[] = [
  {
    // Fixturees the advertiserId used in developmentAdCampaigns
    id: 'ffffffff-ffff-ffff-ffff-ffffffffffff',
    companyName: 'TopMedia Agency',
    contactPerson: 'Chinedu Obi',
    email: 'chinedu@topmedia.ng',
    phone: '+2348055555555',
    website: 'https://topmedia.ng',
  ...
  },
  {
    ...
    email: 'partnerships@nextgen.com',
    phone: '+2348099999999',
    website: 'https://nextgenbev.com',
    industry: 'Food & Beverage',
    address: 'Plot 4, Industrial Ave, Ikeja, Lagos',
    status: 'active',
    createdAt: new Date(),
    updatedAt: new Date(),
  },
