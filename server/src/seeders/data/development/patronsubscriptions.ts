...
export const developmentPatronSubscriptions: PatronSubscriptionAttributes[] = [
  ...
  // Linked to Chief Emeka Ani (ID: ...2222)
  {
    ...
    tier: PatronTier.LEGEND,
    frequency: SubscriptionFrequency.LIFETIME,
    amount: 5000000.00,
    status: SubscriptionStatus.ACTIVE,
