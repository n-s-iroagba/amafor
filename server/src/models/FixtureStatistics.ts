...
export interface FixtureStatisticsAttributes {
  ...
  summary?: string; // Narrative summary/match report

  createdAt?: Date;
  updatedAt?: Date;
}

export interface FixtureStatisticsCreationAttributes extends Optional<FixtureStatisticsAttributes, 'id' | 'createdAt' | 'updatedAt' | 'summary'> { }
