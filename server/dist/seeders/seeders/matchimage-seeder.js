...
exports.FixtureImageSeeder = void 0;
;
...
class FixtureImageSeeder extends base_seeder_1.BaseSeeder {
    constructor() {
        super(FixtureImage_1.default, 'matchimage');
    }
    ...
    async getProductionData() {
        try {
            return matchimages_2.productionFixtureImages || [];
        }
        catch (error) {
    ...
    getTestData() {
        try {
            return matchimages_3.testFixtureImages || [];
        }
        catch (error) {
    ...
    getDevelopmentData() {
        try {
            return matchimages_1.developmentFixtureImages || [];
        }
        catch (error) {
...
exports.FixtureImageSeeder = FixtureImageSeeder;
