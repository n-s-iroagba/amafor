...
exports.developmentFeaturedNewss = [
    {
        ...
        content: '<p>Nigeria have booked their place in the next Africa Cup of Nations...</p>',
        publishedAt: new Date(new Date().setHours(new Date().getHours() - 5)),
...
//# sourceMappingURL=featuredNewss.js.map