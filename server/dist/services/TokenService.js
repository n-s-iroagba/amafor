    ...
    verifyToken(token, tokenType) {
        try {
            ...
            if (decoded.tokenType && decoded.tokenType !== tokenType && decoded.user) {
                ...
                throw new errors_1.UnauthorizedError(`Invalid token type. Expected ${tokenType} but got ${decoded.tokenType}`);
            }
            ...
            if (decoded.nbf && decoded.nbf > now) {
                ...
                throw new errors_1.UnauthorizedError('Token not yet valid');
            }
            ...
            if (error instanceof jsonwebtoken_1.default.JsonWebTokenError) {
                ...
                if (error instanceof jsonwebtoken_1.default.NotBeforeError) {
                    throw new errors_1.UnauthorizedError('Token not active');
                }
...
exports.default = new TokenService('SDD');
