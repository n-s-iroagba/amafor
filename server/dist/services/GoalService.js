...
class GoalService {
    ...
    async createGoal(data) {
        try {
            ...
            if (data.minute < 0 || data.minute > 120) {
                throw new errors_1.AppError('Minute must be between 0 and 120', 400);
            }
    ...
    async updateGoal(id, data) {
        try {
            ...
            if (!updatedGoal) {
                throw new errors_1.AppError('Failed to retrieve updated goal', 500);
            }
    ...
    async bulkCreateFixtureGoals(fixtureId, goalsData) {
        try {
