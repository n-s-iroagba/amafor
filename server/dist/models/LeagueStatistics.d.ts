...
export interface LeagueStatisticsCreationAttributes extends Optional<LeagueStatisticsAttributes, 'id' | 'matchesPlayed' | 'wins' | 'draws' | 'losses' | 'points' | 'goalDifference' | 'homeGoalsFor' | 'homeGoalsAgainst' | 'awayGoalsFor' | 'awayGoalsAgainst' | 'form' | 'cleanSheets' | 'failedToScore' | 'avgGoalsPerFixture' | 'avgGoalsConcededPerFixture' | 'lastFixtureDate'> {
}
