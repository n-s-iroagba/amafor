...
### UJ-PUB-005: View Match Gallery
**User Types:** Fan  
**Entry Point:** `/gallery`  
**Pages Involved:**
- `/gallery` - Match photo galleries
...
### UJ-PUB-006: Scout Player View
**User Types:** Scout  
**Entry Point:** `/pro-view`  
**Pages Involved:**
- `/pro-view` - Professional scouting view
- `/pro-view/[id]` - Detailed player scouting profile

**Steps:**
1. Scout navigates to pro-view
2. Accesses enhanced player profiles
3. Views detailed statistics and performance data
4. May save or export player information
...
**Pages Involved:**
- `/support` - Support options overview
- `/support/patron` - Patron subscription form
...
5. Completes payment setup
6. Name appears on patron wall
...
**Entry Point:** `/academy`  
**Pages Involved:**
- `/academy` - Academy information and trial application form

**Steps:**
1. User navigates to academy page
2. Views academy information
3. Fills trial application form (personal info, position, video URL)
...
- `/dashboard/scout/matches` - Match scouting analysis
- `/dashboard/scout/matches/[id]` - Individual match scouting
- `/dashboard/scout/reports` - Scouting reports

**Steps:**
1. Scout logs in -> checks approval status (DEV-01)
...
- `/dashboard/admin/leagues/[id]/fixtures/[fixtureId]/match-summary` - Match summary
...
- `/dashboard/admin/users/new` - Add user
...
### UJ-ADM-010: Manage Advertisers & Ad Plans
...
- `/dashboard/admin/ad-plans` - Ad plan configuration
- `/dashboard/admin/ad-plans/new` - Create ad plan
...
3. Manages advertiser accounts
4. Configures ad plans and pricing
5. Reviews advertising performance
...
| User Type | Journeys |
|-----------|----------|
| **Fan** | UJ-PUB-001 to UJ-PUB-005, UJ-SUP-003, UJ-UTL-001 to UJ-UTL-003 |
