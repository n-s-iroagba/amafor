    ...
    <div className="bg-white min-h-screen py-20 px-4">
      <div className="max-w-4xl mx-auto">
        <header className="text-center mb-20">
          ...
          <h1 className="text-5xl text-[#2F4F4F] uppercase font-black tracking-tighter mb-4" data-testid="compliance-title">Security Standards</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-20">
          {standards.map((s, i) => (
            <div key={i} className="bg-gray-50 p-8 rounded-[2rem] border border-gray-100 flex flex-col items-center text-center" data-testid={`standard-${i}`}>
        ...
        <section className="bg-[#2F4F4F] rounded-[3rem] p-12 text-white shadow-2xl relative overflow-hidden">
          ...
          <h2 className="text-2xl font-black uppercase tracking-tight mb-8 text-[#87CEEB]" data-testid="integrity-log-title">Data Integrity Log (ADM-11)</h2>
