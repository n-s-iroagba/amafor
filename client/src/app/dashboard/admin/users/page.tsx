...
import { Search, Filter, MoreVertical, Shield, UserPlus, ArrowLeft, Mail, Clock, Edit2 } from 'lucide-react';
import Link from 'next/link';

export default function UserManagementPage() {
  const users = [
    { id: 'u1', name: ' Marcus Scout', email: 'marcus@protalent.com', role: 'Scout', status: 'Active', joined: '2024-03-12' },
    { id: 'u2', name: 'Fatima Ad', email: 'fatima@media-ag.ng', role: 'Advertiser', status: 'Active', joined: '2024-04-01' },
    { id: 'u3', name: 'John Admin', email: 'john@gladiators.com', role: 'Super Admin', status: 'Active', joined: '2023-11-20' },
    { id: 'u4', name: 'Pending User', email: 'new@scout.com', role: 'Scout', status: 'Pending', joined: '2024-05-18' },
  ];
                ...
                <tr key={user.id} className="group hover:bg-gray-50 transition-colors">
                  ...
                  <td className="px-10 py-8">
                    <div className="flex flex-col">
                      ...
                      <span className="text-[9px] text-gray-400 font-bold uppercase mt-1">Level {user.role === 'Super Admin' ? '3' : '1'} Access</span>
                    </div>
                  </td>
                  <td className="px-10 py-8">
                  ...
                  <td className="px-10 py-8 text-xs font-bold text-gray-400 uppercase tracking-tighter">
                    <div className="flex items-center">
                      <Clock className="w-3 h-3 mr-2" /> {new Date(user.joined).toLocaleDateString()}
                    </div>
                  </td>
