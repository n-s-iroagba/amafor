...
export default function AdvertiserReviewDetail() {
  ...
  const handleAction = (type: 'authorizing' | 'denying') => {
    setProcessing(type);
    setTimeout(() => {
      setProcessing(null);
            ...
            <section className="bg-white rounded-[3rem] p-10 shadow-sm border border-gray-100 transition-all hover:shadow-lg">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                 <div>
                    ...
                    <div className="font-mono text-lg font-black text-[#2F4F4F] bg-gray-50 px-4 py-2 rounded-xl border border-transparent inline-block">{company.registered}</div>
                 </div>
                 <div>
          ...
          <aside className="space-y-8">
            <div className="bg-[#2F4F4F] text-white p-10 rounded-[2.5rem] shadow-2xl relative overflow-hidden border-b-8 border-[#87CEEB]">
               ...
               <p className="text-xs text-gray-400 leading-relaxed mb-10 font-bold uppercase tracking-tight">
                 Zenith Sports Retail is categorized under <span className="text-[#87CEEB]">Retail/Athletic</span>. No sector conflicts detected with existing platinum sponsors. Proceed with authorization if document ID: CAC-REV-09 is present.
               </p>
