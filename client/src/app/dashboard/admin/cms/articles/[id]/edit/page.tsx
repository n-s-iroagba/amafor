 ...
 * Edit Article
 * 
 * Interface for modifying existing articles, updating media, and managing version history.
 * 
 * @screen SC-029
 * @implements REQ-CMS-01
 * @usecase UC-CMS-01 (Manage Articles)
 * @requires SRS-I-045 (Articles API - PUT /admin/articles/:id)
 * @performance NFR-PERF-01
 * @observability SRS-OBS-043 Monitor editorial revision volume and publishing delays
 */
"use client";
...
export default function EditArticlePage() {
  ...
  const handleUpdate = async () => {
    ...
    try {
      ...
      router.push(`/dashboard/admin/cms/articles/${id}`);
    } catch (err: any) {
      console.error(err);
      const errorMessage =
