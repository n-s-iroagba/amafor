...
export default function ArticleDetail() {
  ...
  const {
    ...
    loading,
    error,
  } = useGet<Article>(API_ROUTES.ARTICLES.VIEW(id as string));
  const { delete: deleteItem } = useDelete(
    API_ROUTES.ARTICLES.MUTATE(id as unknown as number),
  );
    ...
    <div className="min-h-screen bg-gradient-to-b from-sky-50 to-sky-100 py-8 px-4">
      <div className="max-w-3xl mx-auto bg-white shadow rounded-lg p-6">
        ...
        {article.content?.includes("<img") && (
          <div className="mb-3 sm:mb-4 rounded-lg overflow-hidden shadow-inner relative h-32 sm:h-40 md:h-48 w-full">
            <div
