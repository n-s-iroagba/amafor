        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100">
            <div className="bg-gradient-to-r from-slate-800 to-slate-900 text-white">
                <div className="container mx-auto max-w-3xl px-4 py-8">
                    ...
                    <p className="text-slate-300 text-sm mt-2">Create a team. Players can be assigned after creation (BR-TM-01).</p>
                </div>
            </div>
                ...
                <form onSubmit={handleSubmit} className="bg-white rounded-xl shadow-sm border border-slate-200 p-8 space-y-6">
                    ...
                    <div>
                        ...
                        <div className="flex items-center gap-6">
                            <div className="w-20 h-20 rounded-xl border-2 border-dashed border-slate-300 flex items-center justify-center bg-slate-50 overflow-hidden">
                                {logoPreview ? <img src={logoPreview} alt="Logo preview" className="w-full h-full object-cover" /> : <Upload className="w-6 h-6 text-slate-400" />}
                            </div>
                            <div>
                                <label htmlFor="logo-upload" className="cursor-pointer px-4 py-2 bg-slate-100 hover:bg-slate-200 text-slate-700 rounded-lg text-sm font-medium transition-colors">
                                    Choose Image
                                </label>
                    ...
                    <div>
                        ...
                        <input
                            ...
                            className="w-full px-4 py-3 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-sky-200 text-sm"
                            required
                        />
                    </div>
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            rows={4}
                            className="w-full px-4 py-3 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-sky-200 text-sm resize-none"
                        />
                    </div>

                    <div className="flex items-center justify-end gap-4 pt-4 border-t border-slate-200">
                        <Link href="/dashboard/admin/teams" className="px-6 py-3 text-slate-600 hover:text-slate-800 text-sm font-medium transition-colors">Cancel</Link>
                        <button
                            type="submit"
