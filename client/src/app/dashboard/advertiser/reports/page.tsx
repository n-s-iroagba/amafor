...
export default function HistoricalReportsPage() {
  ...
  const history = [
    { id: 'h1', name: 'Q1 Partnership Drive', date: 'Jan 2024 - Mar 2024', views: '250,000', spend: '₦1,050,000', status: 'completed' },
    { id: 'h2', name: 'Boxing Day Special', date: 'Dec 2023 - Jan 2024', views: '85,000', spend: '₦357,000', status: 'completed' },
    { id: 'h3', name: 'Pre-Season Awareness', date: 'Aug 2023', views: '15,000', spend: '₦63,000', status: 'cancelled' },
  ];
            ...
            <tbody className="divide-y divide-gray-50">
              {history.map(item => (
                <tr key={item.id} className="group hover:bg-gray-50 transition-colors">
                  ...
                  <td className="px-10 py-8 text-xs font-bold text-gray-500 uppercase tracking-tighter">{item.date}</td>
                  <td className="px-10 py-8 font-black text-[#2F4F4F]">{item.views}</td>
                  <td className="px-10 py-8 font-mono text-xs font-bold">{item.spend}</td>
                  <td className="px-10 py-8">
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-white p-10 rounded-[2.5rem] border border-gray-100 shadow-sm flex items-center space-x-8">
             ...
             <div>
                ...
                <div className="text-3xl font-black text-[#2F4F4F]">₦1,470,080</div>
             </div>
          </div>
          <div className="bg-white p-10 rounded-[2.5rem] border border-gray-100 shadow-sm flex items-center space-x-8">
             <div className="bg-[#2F4F4F]/5 p-6 rounded-[2rem]">
             ...
             <div>
                ...
                <div className="text-3xl font-black text-[#2F4F4F]">350,240</div>
             </div>
          </div>
        </div>
      </div>
