                ...
                <main className="py-24 bg-sky-50 min-h-screen">
                    <div className="container mx-auto px-4 max-w-2xl text-center">
                        <div className="bg-white p-12 rounded-lg shadow-card">
                            ...
                            <h1 className="text-3xl font-heading text-sky-800 mb-4">Application Submitted</h1>
                ...
                <div className="container mx-auto px-4 max-w-3xl">
                    ...
                    <div className="bg-white rounded-lg shadow-card p-8 md:p-12">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-8">
                            {/* Player Information */}
                            <section>
                                <h2 className="text-xl font-bold text-sky-800 mb-6 border-b border-sky-100 pb-2">Player Information</h2>
                                <div className="grid md:grid-cols-2 gap-6">
                                    ...
                                    <div>
                                        <label className="block text-sm font-semibold text-sky-700 mb-2">Date of Birth *</label>
                                        <input
                                            type="date"
                                            required
                                            className="w-full px-4 py-3 border border-sky-300 rounded-lg focus:ring-2 focus:ring-sky-700 focus:border-transparent"
                                    ...
                                    <div>
                                        <label className="block text-sm font-semibold text-sky-700 mb-2">Primary Position *</label>
                                        <select
                                            required
                                            className="w-full px-4 py-3 border border-sky-300 rounded-lg focus:ring-2 focus:ring-sky-700 focus:border-transparent"
                            ...
                            {/* Contact Information */}
                            <section>
                                <h2 className="text-xl font-bold text-sky-800 mb-6 border-b border-sky-100 pb-2">Contact Details</h2>
                                <div className="grid md:grid-cols-2 gap-6">
                                    <div>
                                    ...
                                    <div>
                                        <label className="block text-sm font-semibold text-sky-700 mb-2">Phone / WhatsApp *</label>
                                        <input
                                            type="tel"
                                            required
                                            placeholder="+234..."
                                ...
                                <section className="bg-yellow-50 p-6 rounded-xl border border-yellow-200 animate-in fade-in">
                                    ...
                                    <div className="grid md:grid-cols-2 gap-6">
                                        <div className="md:col-span-2">
                                            <label className="block text-sm font-semibold text-sky-700 mb-2">Guardian Full Name *</label>
                                            <input
                                                type="text"
                                                required={isMinor}
                                                className="w-full px-4 py-3 border border-sky-300 rounded-lg focus:ring-2 focus:ring-yellow-500 focus:border-transparent"
                                                value={formData.guardianName}
                                                onChange={e => setFormData({ ...formData, guardianName: e.target.value })}
                                            />
                                        </div>
                                        <div>
                                            <label className="block text-sm font-semibold text-sky-700 mb-2">Guardian Phone *</label>
                                            <input
                                                type="tel"
                                                required={isMinor}
                                                className="w-full px-4 py-3 border border-sky-300 rounded-lg focus:ring-2 focus:ring-yellow-500 focus:border-transparent"
                                        ...
                                        <div>
                                            <label className="block text-sm font-semibold text-sky-700 mb-2">Guardian Email *</label>
                                            <input
                                                type="email"
                                                required={isMinor}
                                                className="w-full px-4 py-3 border border-sky-300 rounded-lg focus:ring-2 focus:ring-yellow-500 focus:border-transparent"
                            ...
                            {/* Assessment Data */}
                            <section>
                                <h2 className="text-xl font-bold text-sky-800 mb-6 border-b border-sky-100 pb-2">Experience & Highlights</h2>
                                <div className="space-y-6">
                                    <div>
                                        <label className="block text-sm font-semibold text-sky-700 mb-2">Previous Club (Optional)</label>
                                        <input
                                            type="text"
                                            className="w-full px-4 py-3 border border-sky-300 rounded-lg focus:ring-2 focus:ring-sky-700 focus:border-transparent"
                                    ...
                                    <div>
                                        <label className="block text-sm font-semibold text-sky-700 mb-2">Highlight Video URL</label>
                                        <input
                                            type="url"
                                        ...
                                        />
                                        <p className="text-xs text-sky-500 mt-1">YouTube, Vimeo, or Google Drive link (Max 100MB equivalent)</p>
                                    </div>
                                </div>
                            </section>

                            {/* Consents (DEV-09) */}
                            <section className="bg-sky-50 p-6 rounded-xl border border-sky-200">
                                <h3 className="font-bold text-sky-800 mb-4">Communications & Consent (BR-TP-06)</h3>
                                ...
                                <div className="space-y-4">
                                    <label className="flex items-start gap-3 cursor-pointer">
                                        <input
                                            type="checkbox"
                                            required
                                            className="mt-1 w-5 h-5 text-sky-700 border-sky-300 rounded focus:ring-sky-700"
                            ...
                            <button
                                type="submit"
                                disabled={isPending}
                                className="w-full bg-sky-700 hover:bg-sky-800 disabled:bg-sky-300 disabled:cursor-not-allowed text-white font-bold py-4 rounded-lg shadow-lg hover:shadow-xl transition-all"
