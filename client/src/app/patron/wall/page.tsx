...
export default function SupporterWall() {
  ...
  const groupedSupporters: Record<string, PatronWithSubscription[]> = {}
                        ...
                        >
                          <div className="flex items-start justify-between gap-3">
                            <div className="flex-1">
                              ...
                              <div className={`text-xs px-2 py-1 rounded-full inline-block ${getTierColor(supporter.subscription.tier)}`}>
