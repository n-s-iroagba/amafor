...
- **Content Displayed**: Match details, score, lineup, statistics
- **Dependencies**: S-008, fixture data
- **Edge Cases**: Fixture not found, match not started

### S-010: Gallery List
- **Screen ID**: S-010
- **File Path**: `/galllery/page.tsx`
- **Screen Type**: List
- **User Role/Persona**: All Users (Fans)
...
- **Screen ID**: S-011
- **File Path**: `/galllery/[id]/page.tsx`
- **Screen Type**: Detail
- **User Role/Persona**: All Users (Fans)
...
- **Validation/Rules**: Required fields
- **Dependencies**: S-059
- **Edge Cases**: Match not completed

### S-071: Match Summary Detail
- **Screen ID**: S-071
...
- **Secondary Actions**: Edit, delete
- **Content Displayed**: Match summary, events, statistics
- **Dependencies**: S-070
- **Edge Cases**: Summary not found

### S-072: Edit Match Summary
- **Screen ID**: S-072
...
- **Content Displayed**: Match list with professional stats
- **Dependencies**: S-115
- **Edge Cases**: No matches, loading state

### S-117: Match Detail (Scout)
- **Screen ID**: S-117
