...
export default function MatchGallerySection() {
  const { data: matchGalleries, loading: galleriesLoading } = useGet<MatchGalleryItem[]>(
                ...
                {match.images && match.images.length > 0 ? (
                  <>
                    <div
                      ...
                      style={{ backgroundImage: `url(${match.images[0].imageUrl})` }}
                    />
